...
function initializeLoans() {
  ...
  la2.LoanPurpose = "My partner needs to loan to buy new equipment for our medical practice";
  la2.LoanAmount = 4800;
  ...
  la3.LoanPurpose = "Go on cruise holiday";
  la3.LoanAmount = 6000;
...
function bindLoansToDropDown() {
  ...
  element.textContent = '...Select an application...';
...
function loadApplication() {
  ...
  var findLoanApp = findLoanApplicationByName(dropDown.value);
  ...
  if (findLoanApp != undefined) {
   ...
   document.getElementById('inputDoBDay').value = findLoanApp.ApplicantDateOfBirth.getDate() ;
   document.getElementById('inputDoBYear').value = findLoanApp.ApplicantDateOfBirth.getFullYear();
   document.getElementById('inputAnnualIncome').value = findLoanApp.ApplicantAnnualIncome;
   document.getElementById('inputAnnualIncome').value = findLoanApp.ApplicantAnnualIncome;
   ...
   document.getElementById('HasCreditcards').checked = hastCreditCards;
   document.getElementById('inputLoanPurpose').value = findLoanApp.LoanPurpose;
   document.getElementById('inputLoanAmount').value = findLoanApp.LoanAmount;

  var riskLabel = document.getElementById("riskSummary");
  riskLabel.style.display = "block";
  riskLabel.innerText = generateRickProfile(findLoanApp); 
  }
}
